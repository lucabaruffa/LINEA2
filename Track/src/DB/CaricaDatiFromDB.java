		...
		public void getDataFromDB() {
		   ...
		   ResultSet rs;
			try {
				...
				rs = stmt_mysql.executeQuery("SELECT distinct codice, postazione,stato_test,data,valore1,valore2 FROM linea5 where data>='"+dax+"' AND postazione <10 order by data asc");	
