...
public class WinDebug extends JFrame implements Runnable {
	...
	public void run() {
		...
		while (true) {
			...
			setting.elenco_indicatori.getIndicatore(0)
					.setBatteriaZeroDebug(setting.elenco_indicatori.getIndicatore(0).getBatteriaZero(), txtZero1);
			setting.elenco_indicatori.getIndicatore(0)
					.setBatteriaZeroDebug(setting.elenco_indicatori.getIndicatore(0).getBatteria(), textProcessata1);
			...
			setting.elenco_indicatori.getIndicatore(1)
					.setBatteriaZeroDebug(setting.elenco_indicatori.getIndicatore(1).getBatteriaZero(), txtZero2);
			setting.elenco_indicatori.getIndicatore(1)
					.setBatteriaZeroDebug(setting.elenco_indicatori.getIndicatore(1).getBatteria(), textProcessata2);

			setting.elenco_indicatori.getIndicatore(2)
					.setBatteriaZeroDebug(setting.elenco_indicatori.getIndicatore(2).getBatteriaZero(), txtZero3);
			setting.elenco_indicatori.getIndicatore(2)
					.setBatteriaZeroDebug(setting.elenco_indicatori.getIndicatore(2).getBatteria(), textProcessata3);

			setting.elenco_indicatori.getIndicatore(3)
					.setBatteriaZeroDebug(setting.elenco_indicatori.getIndicatore(3).getBatteriaZero(), txtZero4);
			setting.elenco_indicatori.getIndicatore(3)
					.setBatteriaZeroDebug(setting.elenco_indicatori.getIndicatore(3).getBatteria(), textProcessata4);

			setting.elenco_indicatori.getIndicatore(4)
					.setBatteriaZeroDebug(setting.elenco_indicatori.getIndicatore(4).getBatteriaZero(), txtZero5);
			setting.elenco_indicatori.getIndicatore(4)
					.setBatteriaZeroDebug(setting.elenco_indicatori.getIndicatore(4).getBatteria(), textProcessata5);

			// setting.elenco_indicatori.getIndicatore(5).setBatteriaZeroDebug(setting.elenco_indicatori.getIndicatore(5).getBatteriaZero(),
			// txtZero6);
			// setting.elenco_indicatori.getIndicatore(5).setBatteriaZeroDebug(setting.elenco_indicatori.getIndicatore(5).getBatteria(),
			// textProcessata6);
			/*
			 * txtZero3.setText(setting.elenco_indicatori.getIndicatore(2).getBatteriaZero()
			 * ); textProcessata3.setText(setting.elenco_indicatori.getIndicatore(2).
			 * getBatteria());
			 * 
			 * txtZero4.setText(setting.elenco_indicatori.getIndicatore(3).getBatteriaZero()
			 * ); textProcessata4.setText(setting.elenco_indicatori.getIndicatore(3).
			 * getBatteria());
			 * 
			 * txtZero5.setText(setting.elenco_indicatori.getIndicatore(4).getBatteriaZero()
			 * ); textProcessata5.setText(setting.elenco_indicatori.getIndicatore(4).
			 * getBatteria());
			 */
			try {
				Thread.sleep(1000);
