...
public class Indicatore {
	...
	public Indicatore(JTextField t, JTextField s, JTextField b, JTextField splc, JTextField sdb, JTextField con,
			JTextField batteriaZ, JTextField risult, JTextField statolin, JTextField tempostato, JTextField scart) {
		tempo = t;
		stato = s;
		batteria = b;
		statodb = sdb;
