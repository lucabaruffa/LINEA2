...
public class WinStory extends JFrame {
	...
	public void impostaTabella() {
		String[][] data = { { "11/11/2020 10:42:27", "0000125450534", "OK", "125", "126", "1" } };
	...
	public void dati() {
		...
		try {
			...
			rs = stmt_mysql.executeQuery("SELECT * FROM " + Setting.TABLE_LINEA + " where codice='" + codice_batteria
					+ "' order by data asc");
			...
			while (rs.next()) {
				...
				try {
					...
					System.out.println(
							"Stampo batteria:" + cod_batteria + "  time:" + timestamp + "   postazione:" + postazione);
	...
	class ColoredTableCellRenderer extends DefaultTableCellRenderer {
		public Component getTableCellRendererComponent(JTable table, Object value, boolean selected, boolean focused,
			...
			if ((postazione.equals("1")) && (column == 4))
				value = value + "";
			if ((postazione.equals("2")) && (column == 4))
				value = value + "";
			if ((postazione.equals("3")) && (column == 4))
				value = value + "";
			if ((postazione.equals("4")) && (column == 4))
				value = value + "";

			if ((postazione.equals("1")) && (column == 5))
				value = value + "";
			if ((postazione.equals("2")) && (column == 5))
				value = value + "";
			if ((postazione.equals("3")) && (column == 5))
				value = value + "";
			if ((postazione.equals("4")) && (column == 5))
				value = value + "";

			if ((postazione.equals("5")) && (column == 4))
				value = value + " [mbar]";
			if ((postazione.equals("6")) && (column == 4))
				value = value + " [mbar]";
			if ((postazione.equals("5")) && (column == 5))
				value = value + " [mbar]";
			if ((postazione.equals("6")) && (column == 5))
				value = value + " [mbar]";
			...
			if ((postazione.equals("8")) && (column == 4))
				value = value + " [g]";
			if ((postazione.equals("9")) && (column == 4))
				value = value + " [g]";
			if ((postazione.equals("8")) && (column == 5))
				value = value + "";
			if ((postazione.equals("9")) && (column == 5))
				value = value + "";

			if ((postazione.equals("1")) && (column == 6))
				value = value + "";
			if ((postazione.equals("2")) && (column == 6))
				value = value + "";
			if ((postazione.equals("3")) && (column == 6))
				value = value + "";
			if ((postazione.equals("4")) && (column == 6))
				value = value + "";
			if ((postazione.equals("5")) && (column == 6))
				value = value + "";
			if ((postazione.equals("6")) && (column == 6))
				value = value + "";
			if ((postazione.equals("7")) && (column == 6))
				value = value + "";
			if ((postazione.equals("8")) && (column == 6))
				value = value + "";

			if ((postazione.equals("9")) && (column == 6))
				value = value + " [g]";
