...
public class WinConfigurazioneLinea extends JFrame {
	...
	public void caricaDatiConfigurazione() {
		...
		try {
			...
			if(dateList[0].statoscanner>0) btn_lettore_1.setSelected(true);
			else btn_lettore_1.setSelected(false);
			
			if(dateList[0].scartoabilitato>0) btn_scarto_1.setSelected(true);
			else  btn_scarto_1.setSelected(false);
			//------------------------------------------------------------
			if(dateList[1].statoscanner>0) btn_lettore_2.setSelected(true);
			else btn_lettore_2.setSelected(false);
			
			if(dateList[1].scartoabilitato>0) btn_scarto_2.setSelected(true);
			else  btn_scarto_2.setSelected(false);
			//------------------------------------------------------------
			if(dateList[2].statoscanner>0) btn_lettore_3.setSelected(true);
			else btn_lettore_3.setSelected(false);
			
			if(dateList[2].scartoabilitato>0) btn_scarto_3.setSelected(true);
			else  btn_scarto_3.setSelected(false);
			//------------------------------------------------------------
			if(dateList[3].statoscanner>0) btn_lettore_4.setSelected(true);
			else btn_lettore_4.setSelected(false);
			
			if(dateList[3].scartoabilitato>0) btn_scarto_4.setSelected(true);
			else  btn_scarto_4.setSelected(false);
			//------------------------------------------------------------
			if(dateList[4].statoscanner>0) btn_lettore_5.setSelected(true);
			else btn_lettore_5.setSelected(false);
...
public void salvaDatiConfigurazione() {
			...
			if(btn_lettore_1.isSelected()) dateList[0].statoscanner=256;
			else dateList[0].statoscanner=0;
		
			if(btn_scarto_1.isSelected()) dateList[0].scartoabilitato=256;
			else dateList[0].scartoabilitato=0;
			
			dateList[0].spare1 = 0;
			dateList[0].spare2 = 0;
			//------------------------------------------------------------
			if(btn_lettore_2.isSelected()) dateList[1].statoscanner=256;
			else dateList[1].statoscanner=0;
		
			if(btn_scarto_2.isSelected()) dateList[1].scartoabilitato=256;
			else dateList[1].scartoabilitato=0;
			
			dateList[1].spare1 = 0;
			dateList[1].spare2 = 0;
			//------------------------------------------------------------
			if(btn_lettore_3.isSelected()) dateList[2].statoscanner=256;
			else dateList[2].statoscanner=0;
		
			if(btn_scarto_3.isSelected()) dateList[2].scartoabilitato=256;
			else dateList[2].scartoabilitato=0;
			
			dateList[2].spare1 = 0;
			dateList[2].spare2 = 0;
			//------------------------------------------------------------
			if(btn_lettore_4.isSelected()) dateList[3].statoscanner=256;
			else dateList[3].statoscanner=0;
		
			if(btn_scarto_4.isSelected()) dateList[3].scartoabilitato=256;
			else dateList[3].scartoabilitato=0;
			
			dateList[3].spare1 = 0;
			dateList[3].spare2 = 0;
			//------------------------------------------------------------
			if(btn_lettore_5.isSelected()) dateList[4].statoscanner=256;
			else dateList[4].statoscanner=0;
		
			if(btn_scarto_5.isSelected()) dateList[4].scartoabilitato=256;
			else dateList[4].scartoabilitato=0;
			
			dateList[4].spare1 = 0;
			dateList[4].spare2 = 0;
			//------------------------------------------------------------
			try {
				if(btn_lettore_6.isSelected()) dateList[5].statoscanner=256;
				else dateList[5].statoscanner=0;

				if(btn_scarto_6.isSelected()) dateList[5].scartoabilitato=256;
				else dateList[5].scartoabilitato=0;
				...
				if(btn_scarto_7.isSelected()) dateList[6].scartoabilitato=256;
				else dateList[6].scartoabilitato=0;
			...
			JOptionPane.showMessageDialog(getContentPane(), "Configurazione Salvata!","OK",JOptionPane.INFORMATION_MESSAGE);
...
public void salvaDatiConfigurazionePostazioneInterblocco(JToggleButton btn_scarto) {
	...
	if(btn_scarto.isSelected()) dateList[(Setting.STAZIONE_DI_CONTROLLO_2)-1].scartoabilitato=256;
	else dateList[(Setting.STAZIONE_DI_CONTROLLO_2)-1].scartoabilitato=0;
