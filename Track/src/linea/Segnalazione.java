	...
	public Segnalazione() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent e) {
				if (invia()) {
					JOptionPane.showMessageDialog(contentPane, "Segnalazione inviata!","INVIO",JOptionPane.INFORMATION_MESSAGE);
					dispose();
					
				}
				else JOptionPane.showMessageDialog(contentPane, "Si è verificato un problema nell'invio della segnalazione!","ERRORe",JOptionPane.ERROR_MESSAGE);
			}
		});
