...
public class Batteria {
	...
	public String stato_batteria = "";
	private int index = 0; // posizione dei valori nell'array del plc ; 0 è la prima batteria (top) in
							// lavorazione
	private int dato1 = -1;
	private int dato2 = -1;
	...
	public String getStatoBatteria() {
		// if ((this.stato_batteria.contains("TRUE")) ||
		// (this.stato_batteria.contains("true")))
