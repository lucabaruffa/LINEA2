...
public class SettingFrame extends JFrame {
	...
	public SettingFrame() {
		...
		try {
			...
			JOptionPane.showMessageDialog(contentPane, "ERRORE NEL CARICAMENTO DELLA CONFIGURAZIONE!","ERRORE",JOptionPane.ERROR_MESSAGE);
			e2.printStackTrace();
		}
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent e) {
				...
				try {
					...
					JOptionPane.showMessageDialog(contentPane, "Configurazione salvata!","AVVISO",JOptionPane.INFORMATION_MESSAGE);
				} catch (Exception e1) {
					JOptionPane.showMessageDialog(contentPane, "ERRORE NEL SALVATAGGIO DELLA CONFIGURAZIONE!","ERRORE",JOptionPane.ERROR_MESSAGE);
					e1.printStackTrace();
				}
